<template>
  <q-card style="max-width: 300px; width: 300px">
    ...
    <q-toolbar class="bg-red text-white">
      <q-toolbar-title> Deactivate Semester </q-toolbar-title>
    ...
    <q-card-section>
      ...
      >
        <div class="text-center">
          <p class="text-h6">Are you sure you want to deactivate this Semester option?</p>
          <q-btn
            unelevated
            label="Close"
...
export default {
  ...
  methods: {
    async onChangeStatus() {
      await api
        .patch(
          "/api/settings/semesters/changestatus",
          {
            sem_id: this.semId,
          },
          {
