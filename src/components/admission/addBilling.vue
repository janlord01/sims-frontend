<template>
  <q-card style="max-width: 1200px; width: 1200px">
    ...
    <q-toolbar class="bg-secondary text-white">
      <q-toolbar-title> Add Billings </q-toolbar-title>
      ...
      <q-card>
        ...
        {{ props.row.name }} -->
          ...
          <q-tab-panel name="group_billing">
            <BillingGroupList :year-id="yearId" :course-id="courseId" />
          </q-tab-panel>
...
import BillingGroupList from "./billing-group-list.vue";
...
export default {
  ...
  mounted() {
    ...
    this.getAllGroupbilling([this.courseId, this.yearId]);
