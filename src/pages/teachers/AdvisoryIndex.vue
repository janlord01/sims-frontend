<template>
  <q-page class="">
    <div class="bg-white text-black shadow-2">
      <q-toolbar class="">
        <q-toolbar-title class="text-h6">Advisor</q-toolbar-title>

        <!-- <q-btn
          icon="add_circle"
          color="grey"
          size="sm"
          style="height: 50px; margin-top: 10px; margin-bottom: 10px; margin-right: 5px"
      ...
      <q-dialog v-model="showCreateDialog">
        <createBlockSection @hide-create-dialog="showCreateDialog = !showCreateDialog" />
      </q-dialog>
    </div>
  </q-page>
</template>
...
import advisoryList from "src/components/teachers/AdvisoryList.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    ...mapActions("TeacherUserStore", ["getAllSections"]),
