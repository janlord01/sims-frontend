<template>
  <q-page class="">
    <div class="bg-white text-black shadow-2">
      <q-toolbar class="">
        <q-toolbar-title class="text-h6">Scholarship Discount List </q-toolbar-title>
...
import discountList from "src/components/finances/scholarship/discountList.vue";
import createDialog from "src/components/finances/scholarship/createDiscount.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    ...mapActions("DiscountStore", ["getAllDiscountScholar"]),
