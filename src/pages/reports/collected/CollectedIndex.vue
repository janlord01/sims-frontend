<template>
  <q-page class="">
    <div class="bg-white text-black shadow-2">
      <q-toolbar class="">
        <q-toolbar-title class="text-h6">Account Collected</q-toolbar-title>
...
import collectedList from "src/components/reports/collected/collectedList.vue";
  ...
  methods: {
    ...
    getCollectedCourseFunc() {
      if (this.formData.course == null) {
        ...
        this.getCollectedCourse(this.formData.course.value);
      }
    },
    onShowCreateDialog() {
