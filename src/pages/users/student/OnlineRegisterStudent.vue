<template>
  <q-page class="">
    <div class="bg-white text-black shadow-2">
      ...
      />
      <q-toolbar class="">
        <q-toolbar-title class="text-h6">Online Registration</q-toolbar-title>
      </q-toolbar>
          ...
          <div class="schoolInfo" v-if="formData.transferee == 'yes'">
            ...
            <div class="row q-col-gutter-none q-mt-md">
              <q-input
                ...
                :class="
                  $q.screen.gt.sm ? 'q-mr-sm col-3 ' : 'full-width q-mb-md'
                "
              >
                <template v-slot:prepend>
            ...
            <div class="row q-col-gutter-none q-mt-md">
              ...
              <q-input
                ...
                name="schoolID"
                :class="
                  $q.screen.gt.sm ? 'q-mr-sm col-3 ' : 'full-width q-mb-sm'
                "
              >
                <template v-slot:prepend>
                  <q-icon name="holiday_village" />
      ...
      await api
        .post(
          "/api/online-registration/store",
          {
            ...
            course: this.formData.course.label
              ? this.formData.course.label
              : null,
          },
          {
            headers: {
        ...
        .then((response) => {
          ...
          if (response.data.status == 200) {
            setTimeout(() => {
              ...
              this.formData.stayWith = "";
              this.formData.transferee = "";
              this.formData.lastSchool = "";
              this.formData.lastYear = "";
              this.formData.schoolName = "";
              this.formData.schoolAddress = "";
              this.formData.schoolID = "";
              this.formData.email = "";
